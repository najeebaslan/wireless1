  ...
  runApp(
    MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider<UtilsUserProvider>(
            create: (_) => UtilsUserProvider(),
          ),
          ChangeNotifierProvider<NetworkProvider>(
            create: (_) => NetworkProvider(),
          ),
          ChangeNotifierProvider<ProviderNetworkDetails>(
            create: (_) => ProviderNetworkDetails(),
          ),
          ChangeNotifierProvider<ProviderCoverageArea>(
            create: (_) => ProviderCoverageArea(),
          ),
        ...
        child: FeatureDiscovery(
            ...
            /* ومشاكل عمل اعادة بناء لكل الصفحات التي تتوفر فيها  MediaQuery هنا من اجل Scaffold  مهم جدا اضافة ال  */
            child: MyApp())),
  );
}
